...
class AccountController extends AppBaseController
{
    ...
    public function applyForPayout(Request $request)
    {
        ...
        if (Auth::user()->id != $account->user_id) {
            Flash::error('You cannot perform this operation on an account that is not you');
            return redirect()->back();
        }
        ...
        AccountHistory::create([
            ...
            'message' => 'Payout request initiated by account own'
        ]);
    ...
    public function markAsPaid(Request $request)
    {
        ...
        if (Auth::user()->role_id > 2) {
            Flash::error('You cannot perform this operation if you are not admin');
            return redirect()->back();
        }
